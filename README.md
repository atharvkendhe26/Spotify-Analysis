...
engagement, listening trends, skip behavior, and peak listening periods. This project addresses these challenges by developing a 
...
slicers for dynamic filtering. Multiple visualizations such as line charts, bar charts, donut charts, scatter plots, gauge charts,
...
Skip Rate is only 5.25%, indicating strong user engagement. The monthly trend charts show that September 
recorded the highest streams, listening hours, and listening minutes, followed by a gradual decline in the 
following months. The completion analysis reveals that 94.75% (141.99K) of tracks were completed, whereas 
only 5.25% (7.87K) were skipped. Listening category analysis shows that Long Listening (61.09%) dominates 
...
listening time, followed by Wednesday and Thursday, indicating increased music consumption towards the 
weekend. Artist-wise listening hours identify The Beatles as the most listened-to artist, followed by The 
Killers, John Mayer, and Bob Dylan. The scatter plot demonstrates a strong positive relationship between 
Total Minutes Listened and Total Streams, suggesting that artists with higher listening time naturally 
...
detailed table provides artist-wise information including first track name, total streams, and listening hours, 
making it easy to compare individual performance. The Completed vs Skipped Tracks visual confirms 
excellent user retention, with 141.99K completed streams compared to only 7.87K skipped streams. The Skip 
Rate gauge (5.25%) further reinforces that users rarely skip songs, indicating high listener satisfaction and 
content relevance. Overall, the dashboard successfully identifies the top-performing artists, tracks, and 
listening patterns while highlighting strong user engagement across the platform.
